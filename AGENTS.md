# AI-Agenten in diesem Projekt

Dieses Dokument beschreibt die verschiedenen KI-Agenten, die in diesem Projekt verwendet werden, ihre Rollen und wie man am besten mit ihnen interagiert.

## Haupt-Assistent (Gemini)

Dies ist der primäre Entwicklungsassistent, der direkt in der IDE zur Verfügung steht.

*   **Rolle:** Allzweck-Assistent für Code-Erstellung, Fehlerbehebung, Dokumentation und allgemeine Fragen zur Android-Entwicklung.
*   **Fähigkeiten:**
    *   Code in verschiedenen Sprachen schreiben und vervollständigen (insbesondere Kotlin).
    *   Bestehenden Code refaktorisieren und verbessern.
    *   KDoc- und andere Dokumentationsformate erstellen.
    *   Fehler im Code analysieren und Lösungen vorschlagen.
    *   Git-Befehle ausführen.
*   **Anwendungsbeispiel:**
    > "@gemini erstelle eine KDoc-Dokumentation für die aktuell geöffnete Datei."

---

# Leitfaden zur App-Architektur

Die folgenden Prinzipien und Best Practices für die Android-App-Architektur sollen vom KI-Assistenten bei allen Code-Änderungen und -Vorschlägen beachtet werden.
